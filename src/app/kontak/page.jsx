            ...
            <div className="bg-[#0D0D0D] p-12 rounded-2xl border border-gray-600 mb-16 max-md:p-8 max-sm:p-4">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-sm:gap-4">
                ...
                <div className="w-full">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.338981620444!2d107.6255820757401!3d-6.969276668241611!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e9bc3974981d%3A0x613eec0feec9fcf7!2sTelkom%20University%20Landmark%20Tower%20(TULT)!5e0!3m2!1sen!2sid!4v1751710365036!5m2!1sen!2sid"
                    width="100%"
                    height="400"
                    style={{ border: 0 }}
                    allowFullScreen
